...
| Campo | Valor |
|---|---|
| Repositorio | `javascript_example_secrets_management` |
...
Gestao centralizada de segredos e configuracao sensivel. Este documento descreve requisitos, arquitetura e criterios de aceite.
